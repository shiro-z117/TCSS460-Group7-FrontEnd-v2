  ...
  useEffect(() => {
    const fetchMovies = async () => {
      ...
      try {
        ...
        setTotalPages(Math.ceil((response.data.total || moviesData.length) / itemsPerPage));
        setTotalResults(response.data.total || moviesData.length);
      } catch (error) {
      ...
      <main className="ml-64 flex-1 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mb-6">
            {isLoading ? 'Loading...' : `Browse ${totalResults} movies`}
          </p>
